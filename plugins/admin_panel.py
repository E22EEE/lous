    ...
    if user_id in admins:
        keys = mk(
            [
                ...
                [btn('اذاعه', 'brod')],
                [btn('جلب معلومات شخص', 'get_info'), btn('حظر', 'ban_me')],
                [btn('وخر الحظر ', 'unban_me')],
                [btn('تعيين سعر منتج ', 'set_price'), btn('اضافه رقم', 'gen')],
                [btn(f'الارقام: {num}', 'nonee')],
                [btn('اضافه vip', 'onp'), btn('  وخر الـvip', 'offp')]
            ]
        )
